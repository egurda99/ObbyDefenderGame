...
{
    public sealed class TurretUpgradesPresenter
    {
        ...
        public TurretUpgradesPresenter(UpgradeConfig upgradeConfig, IUpgradeView view, UpgradesManager upgradeManager)
        {
